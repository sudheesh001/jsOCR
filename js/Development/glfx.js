var fx = function () {
  ...
  function z(a) {
    ...
    for (var c = 0; c < d; c++) this.xa.push(a[c][0]),
    this.ya.push(a[c][1]);
    this.u[0] = 0;
    this.y2[0] = 0;
    for (c = 1; c < d - 1; ++c) {
  ...
  function t(a) {
    a = new z(a);
    for (var d = [
    ], c = 0; 256 > c; c++) d.push(q(0, Math.floor(256 * a.interpolate(c / 255)), 255));
    return d
  }
  function I(b, d, c) {
    b = t(b);
    ...
    for (var e = [
    ], g = 0; 256 > g; g++) e.splice(e.length, 0, b[g], d[g], c[g], 255);
  ...
  function Q(b, d, c) {
    ...
    [
      ...
      e.push([b * Math.sin(l) / this.width,
  ...
  function aa(a, d) {
    ...
    e = x.apply(null, a),
    c = y(c);
    return this.matrixWarp([c[0] * e[0] + c[1] * e[3] + c[2] * e[6],
  ...
  (function () {
    function a(b) {
      ...
      b.texParameteri(b.TEXTURE_2D, b.TEXTURE_WRAP_S, b.CLAMP_TO_EDGE);
      b.texParameteri(b.TEXTURE_2D, b.TEXTURE_WRAP_T, b.CLAMP_TO_EDGE);
      b.texImage2D(b.TEXTURE_2D, 0, b.RGBA, 2, 2, 0, b.RGBA, b.FLOAT, new Float32Array([2,
      0,
      0,
      0,
      0,
      ...
      b.bufferData(b.ARRAY_BUFFER, new Float32Array([0,
      0]), b.STREAM_DRAW);
  ...
  var h = function () {
    ...
    d.prototype.drawRect = function (b, c, e, d) {
      ...
      e,
      d]), a.STATIC_DRAW);
      null == a.texCoordBuffer && (a.texCoordBuffer = a.createBuffer(), a.bindBuffer(a.ARRAY_BUFFER, a.texCoordBuffer), a.bufferData(a.ARRAY_BUFFER, new Float32Array([0,
      0,
      0,
      1,
      1,
